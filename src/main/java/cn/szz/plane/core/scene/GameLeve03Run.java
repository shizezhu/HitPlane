...
public class GameLeve03Run extends GameRun {
    ...
    public GameLeve03Run() {
        super(new GameBg(new Image(ImageEnum.GAME_BG_03, 0, 0, UIConfig.INSTANCE.getWindowWidth(), UIConfig.INSTANCE.getWindowHeight())),
                new DefaultBgSound(SoundPathEnum.GAME_LEVEL_03_BG));
        playerList.add(PlayerFactory.produce(getUser(), 3));
