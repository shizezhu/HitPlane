...
public class GameLeve04Run extends GameRun {
    ...
    public GameLeve04Run() {
        super(new GameBg(new Image(ImageEnum.GAME_BG_04, 0, 0, UIConfig.INSTANCE.getWindowWidth(), UIConfig.INSTANCE.getWindowHeight())),
                new DefaultBgSound(SoundPathEnum.GAME_LEVEL_04_BG));
