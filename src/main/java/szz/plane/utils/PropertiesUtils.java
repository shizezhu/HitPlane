...
public class PropertiesUtils {
    ...
    public String get(String key) throws CheckException {
        return CheckUtils.ifIsTrueOrElseGet(CheckUtils.isEmpty(key) || CheckUtils.isNull(prop),
                () -> null, () -> prop.getProperty(key));
    }
    ...
    public Map<String, String> get(String... keys) throws CheckException {
        ...
        CheckUtils.ifIsFalse(CheckUtils.isEmpty(keys) || CheckUtils.isNull(prop),
                () -> Stream.of(keys).forEach(key -> CheckUtils.ifNotNull(prop.getProperty(key), value -> map.put(key, value))));
        return map;
    }
